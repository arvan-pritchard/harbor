...
docker pull cicd.harbor.bitsf.xin/harbor-dev/registry-photon:v2.7.1-patch-2819
docker tag cicd.harbor.bitsf.xin/harbor-dev/registry-photon:v2.7.1-patch-2819 cicd.harbor.bitsf.xin/harbor-dev/registry-photon:v2.7.1-patch-2819-$TAG
...
openssl x509 -req -days 365 -sha256 -in $cert_path/$IP.csr -CA $cert_path/harbor_ca.crt \
	-CAkey $cert_path/harbor_ca.key -CAcreateserial -extfile $cert_path/extfile.cnf -out $cert_path/$IP.crt
